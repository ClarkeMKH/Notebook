...
function Update-From-N8N {
    $response = Invoke-RestMethod -Uri "https://automation.harrison-home.co.uk/webhook/d8a4d3ae-8d71-4316-af21-70e6ffc9e427" -Method Get
    ...
    Read-Host "Terminal-Companion has been updated.`n`nPress any button to exit..."
    exit
}
...
function Update-Script-In-N8N {
    $response = Invoke-RestMethod -Uri "https://automation.harrison-home.co.uk/webhook/95dcf92c-42f2-46fe-ae63-8573696e9d85" -Method Post -Body (@{Code = (Get-Content -Path $PSCommandPath -Raw)} | ConvertTo-Json) -ContentType "application/json"
    Clear-Host
