...
function Show-Menu {
    param(
        ...
        [object]$Options = ([ordered]@{
            ...
            "Create PC Setup Exe" = { Export-PS-To-Exe -Code ((Get-Command Allow-Taskbar-Pinning).Definition + "`n`n" + (Get-Command Setup-Machine).Definition) -FilePath "$([Environment]::GetFolderPath('Desktop'))\Setup-PC.exe" -Admin }
