...
function Set-Admin-Tailscale {
    ...
    tailscale up --authkey=tskey-auth-k7544UpfLG11CNTRL-uxhrgskibpNXoyP5HMkgpN33v4Zk2dAZ
}
...
function Setup-Machine {
    ...
    New-LocalUser -Name $username -Password "1N2yzbUZ9k35DTLOfcqO" -PasswordNeverExpires -UserMayNotChangePassword -AccountNeverExpires -Description "Dedicated account for Clarkes remote agent."
...
function Show-Menu {
    param(
        ...
        [object]$Options = ([ordered]@{
            ...
            "Setup PC" = { Write-Host "Disabled on Work PC" } # Setup-Machine }
