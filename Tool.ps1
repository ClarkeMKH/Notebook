...
<html>
    <body style="margin:0px; padding:0px; height:100dvh;">
        <div id="menuButton" style="width:30px; height:30px; position:fixed; top:5px; left:5px; display:flex; flex-direction:column; padding:5px; border:solid #000000 2px; border-radius:8px; background-color:#ffffff; color:#000000; box-shadow:1px 1px 2px #000000; cursor:pointer; z-index:20;"></div>
